...
function App() {
  return (
    <main className="relative min-h-screen bg-gradient-to-br from-purple-800 via-indigo-900 to-black overflow-hidden font-roboto-custom z-0 text-white flex flex-col scroll-smooth">
      <BubbleEffect />
      <Header />
      <HeroSection />
      <Habilities />
